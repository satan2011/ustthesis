...
\ustcsetup{
	...
	author             = {李泽平},                        %作者
	author*            = {Li Zeping},
	speciality         = {数学与应用数学},                 %专业/学科、专业名称/专业学位类别
	speciality*        = {Mathematics and Applied Mathematics},
	supervisor         = {XXX~教授, XXX~教授},            %导师/指导教师
	supervisor*        = {Prof. XXX, Prof. XXX},
	advisor         	 = {AAA~教授, XXX~教授},            %校外导师
	cid        			 = {TP79；P23},		              %分类号
	schoolcode      	 = {10720},   		               %代为代码  
	research        	 = {无人机遥感监测},                %研究方向/专业领域名称
	date               = {2017-05-01},                   %论文完成时间 默认为今日
	% professional-type  = {专业学位类型},                %学位类型已经放到了专业 speciality中  
	% professional-type* = {Professional degree type},
	% department         = {数学科学学院},              % 院系
	student-id         = {PB11001000},                 % 学号
	%secret-level       = {公开},                       % 绝密|机密|秘密|控阅，注释本行则公开
